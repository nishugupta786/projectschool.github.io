...
<!-- Contact Start -->
	...
	<div class="mb-3">
      ...
      <input type="text" class="form-control" id="subject" placeholder="Enter mobile no" name="mobile" required/>
    </div>
	
	<div class="mb-3 mt-3">
     
      <textarea class="form-control" rows="5" id="Message" placeholder="Enter message" name="text"></textarea>
    </div>
	
      <input type="submit" class="btn btn-primary" name="submit" value="resgister">
      <a href="selectquery_display.php" target="_blank"><button type="button" class="btn btn-primary">display data</button></a>
...
$message=$_POST['text'];
                        ...
                        //tablename contactform//mysql name name,email//

//$insertquery ="INSERT INTO `contactform` (`name`, `email`, `password`, `sub`, `message`) VALUES ( '$name', '$email', '$password', '$mobileno', '$message')";
